...
void mml::frame_size_calculator::do_func_call_node(mml::func_call_node *const node, int lvl) {
  // EMPTY
}
...
void mml::frame_size_calculator::do_mem_alloc_node(mml::mem_alloc_node *const node, int lvl) {
  // EMPTY
}
...
void mml::frame_size_calculator::do_variable_decl_node(mml::variable_decl_node *const node, int lvl) {
  _localsize += node->type()->size();
}

void mml::frame_size_calculator::do_func_definition_node(mml::func_definition_node *const node, int lvl) {
  node->block()->accept(this, lvl + 2);
}
